    ...
    <div className="relative z-20">
      <div className="fixed flex flex-row justify-around w-full pt-4 pb-4 text-xl font-bold bg-primary-yellow ">
        ...
        <FontAwesomeIcon
          ...
          className="block w-12 h-12 mr-2 transition duration-300 ease-in-out delay-150 md:hidden hover:-translate-y-1 hover:scale-110"
        />
      </div>
      <div
        className={`${
          open ? "flex" : "hidden"
        } relative z-20 flex-col items-center justify-center w-full h-80 bg-primary-yellow md:hidden`}
      >
        <FontAwesomeIcon
          icon={faXmark}
          onClick={() => setOpen(!open)}
          className="block w-12 h-12 ml-64 transition duration-300 ease-in-out delay-150 md:hidden hover:-translate-y-1 hover:scale-110"
        />
        <nav>
          <ul className="flex-col items-center justify-center mt-8 text-center lg:hidden ">
            <li>
              <a
                href=""
                className="pr-3 mb-2 text-2xl font-semibold hover:text-primary-yellow active:hover:text-primary-yellow"
              >
                Strona główna
              </a>
            </li>
            <li>
              <a
                href=""
                className="pr-3 text-2xl font-semibold hover:text-primary-yellow active:hover:text-primary-yellow"
              >
                Oferta
              </a>
            </li>
